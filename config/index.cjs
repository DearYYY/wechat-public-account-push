...
const USER_CONFIG = {
  ...
  USERS: [
    {
      ...
      useTemplateId: 'hKT6S9Wr8ViUTyrajwQWEqQkOR5IIOlFRl-aZao3iGY',
     ...
     horoscopeDate: '02-19',
      ...
      customizedDateList: [
        // 在一起的日子
        { keyword: 'love_day', date: '2023-05-12' },
        // 结婚纪念日
        { keyword: 'marry_day', date: '2023-05-12' },
      ],
    },
  ],
  ...
  CALLBACK_TEMPLATE_ID: 'hKT6S9Wr8ViUTyrajwQWEqQkOR5IIOlFRl-aZao3iGY',
